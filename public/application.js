...
/***/ (function(module, exports, __webpack_require__) {
	...
	var appEvents = __webpack_require__(7);
	...
	$(document).on('click', '.delete-event', function (e) {
	  event.preventDefault();
	  var deleteEventId = $(this).attr('id');
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://solopreneur.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var appApi = __webpack_require__(8);
	...
	var loginUser = function loginUser(e) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  appApi.userLogin(data).then(appUi.onSigninSuccess).catch(appUi.onSigninFailure);
	};

	// logout event
	var logoutUser = function logoutUser(e) {
	...
	var createEvent = function createEvent(e) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  appApi.newEvent(data).then(appUi.onCreateEventSuccess).catch(appUi.onCreateEventFailure);
	};

	var deleteEvent = function deleteEvent(deleteEventId) {
	  appApi.deleteEvent(deleteEventId).then(appUi.onDeleteEventSuccess).catch(appUi.onDeleteEventFailure);
	};

	var updateEvent = function updateEvent(eventID, data) {
	  appApi.updateAnEvent(eventId, data).then(appUi.onUpdateEventSuccess).catch(appUi.onUpdateEventFailure);
	};

	var createComment = function createComment(e) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  appApi.newComment(data).then(appUi.onCreateCommentSuccess).catch(appUi.onCreateCommentFailure);
	};

	var deleteComment = function deleteComment(deleteCommentId) {
	  appApi.deleteComment(deleteCommentId).then(appUi.onDeleteCommentSuccess).catch(appUi.onDeleteCommentFailure);
	};

	var updateComment = function updateComment(commentId, data) {
	  appApi.editSurvey(commentId, data).then(appUi.onUpdateCommentSuccess).catch(appUi.onUpdateCommentFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateAnEvent = function updateAnEvent(eventId, data) {
	...
	var deleteEvent = function deleteEvent(deleteId) {
	  return $.ajax({
	...
	var viewAllEvents = function viewAllEvents() {
	  return $.ajax({
	    url: config.apiOrigin + '/events',
	    method: 'GET'
	  });
	...
	var viewOneEvent = function viewOneEvent(eventID) {
	  return $.ajax({
	    url: config.apiOrigin + '/events/' + eventID,
	    method: 'GET'
	  });
	...
	var editProfile = function editProfile(id, data) {
	...
	var newComment = function newComment(data) {
	  return $.ajax({
	...
	var deleteComment = function deleteComment(deleteId) {
	  return $.ajax({
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  host: 'https://solopreneur.herokuapp.com'
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onLogoutSuccess = function onLogoutSuccess(app) {
